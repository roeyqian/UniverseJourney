...
import roeyqian.universejourney.screen.recipe.UniverseCookingBookComponent;

public class UniverseRefineryScreen extends AbstractRecipeBookScreen<UniverseRefineryMenu> {
    ...
    public UniverseRefineryScreen(
            UniverseRefineryMenu handler,
            Inventory inventory,
            Component title
    ) {
        super(handler, new UniverseCookingBookComponent(handler), inventory, title);
    }
