...
public class UniverseCookingBookComponent extends RecipeBookComponent<UniverseRefineryMenu> {
    ...
    public UniverseCookingBookComponent(UniverseRefineryMenu handler) {
        super(handler, TABS);
    }
